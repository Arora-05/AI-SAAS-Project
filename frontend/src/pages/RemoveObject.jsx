  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
      text-slate-700'>
          ...
          <input onChange={(e)=>setInput(e.target.files[0])} type="file" className='w-full p-2 px-3 mt-2 outline-none
          text-sm rounded-md border border-gray-300 text-gray-600' accept='image/*' required/>
          ...
          text-sm rounded-md border border-gray-300' placeholder='e.g., glass or watch, Single object name ' required/>
